...
**修改內容**:
- [ ] 將 "Frankly ID" 改為 "User ID"
- [ ] 將 "Member status" 改為 "Member Status" 
- [ ] 新增 "Join Time" 欄位 (需要從參與者資料中取得首次加入時間)
- [ ] 新增 "Room Assigned" 欄位 (需要從分組房間資料中取得)
- [ ] 將 "Answer 1", "Answer 2" 改為 "Question 1", "Answer 1", "Question 2", "Answer 2" 格式
- [ ] 檔案名稱改為 `registration-data-new.csv`
...
- [ ] 將 "RoomId" 改為 "Room" 並顯示房間名稱
- [ ] 保留 Upvotes, Downvotes 欄位
- [ ] 檔案名稱改為 `polls-suggestions-data-new.csv`
