...
export class FirestoreHelper {
    ...
    getPathToDiscussionThreadsTrigger(): string {
        return `${this.getPathToCommunityTrigger()}/${FirestoreHelper.kDiscussionThreads}/{${
            FirestoreHelper.kDiscussionThreadId
        }}`
    }

    getPathToDiscussionThreadsCollection({ communityId }: { communityId: string }): string {
        return `${this.getPathToCommunityDocument({ communityId })}/${
            FirestoreHelper.kDiscussionThreads
        }`
    }
    ...
    getPathToDiscussionThreadCommentsTrigger(): string {
        return `${this.getPathToDiscussionThreadsTrigger()}/${
            FirestoreHelper.kDiscussionThreadComments
        }/{${FirestoreHelper.kDiscussionThreadCommentId}}`
    }
    ...
    getPathToDiscussionThreadCommentsCollection({
        ...
        return `${this.getPathToDiscussionThreadsDocument({ communityId, discussionThreadId })}/${
            FirestoreHelper.kDiscussionThreadComments
        }`
    }
