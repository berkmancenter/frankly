...
exports.UnsubscribeFromCommunityNotifications = new UnsubscribeFromCommunityNotifications().register();
...
exports.ToggleLikeDislikeOnMeetingUserSuggestion = new ToggleLikeDislikeOnMeetingUserSuggestion().register();
...
exports.UpdateLiveStreamParticipantCount = new UpdateLiveStreamParticipantCount().register(functions);
...
function registerFirestoreFunctions(record: Record<string, functions.CloudFunction<unknown>>): void {
  for (const [name, fn] of Object.entries(record)) {
    exports[name] = fn;
  }
}

registerFirestoreFunctions(new OnCommunity().register() as Record<string, functions.CloudFunction<unknown>>);
registerFirestoreFunctions(new OnCommunityMembership().register() as Record<string, functions.CloudFunction<unknown>>);
registerFirestoreFunctions(new OnEvent().register() as Record<string, functions.CloudFunction<unknown>>);
registerFirestoreFunctions(new OnPartnerAgreements().register() as Record<string, functions.CloudFunction<unknown>>);
registerFirestoreFunctions(new OnDiscussionThread().register() as Record<string, functions.CloudFunction<unknown>>);
registerFirestoreFunctions(new OnDiscussionThreadComment().register() as Record<string, functions.CloudFunction<unknown>>);
registerFirestoreFunctions(new OnTemplate().register() as Record<string, functions.CloudFunction<unknown>>);
