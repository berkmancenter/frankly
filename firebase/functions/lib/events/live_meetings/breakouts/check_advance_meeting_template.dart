...
class CheckAdvanceMeetingTemplate
    extends OnCallMethod<CheckAdvanceMeetingTemplateRequest> {
  CheckAdvanceMeetingTemplate()
      : super(
          'CheckAdvanceMeetingTemplate',
          (jsonMap) => CheckAdvanceMeetingTemplateRequest.fromJson(jsonMap),
        );
  ...
  Future<void> action(
    ...
    await _checkAdvanceMeetingTemplate(
  ...
  Future<void> _checkAdvanceMeetingTemplate({
    required bool isBreakout,
    required String userId,
    required String liveMeetingPath,
    required String? parentLiveMeetingPath,
    required CheckAdvanceMeetingTemplateRequest request,
  }) async {
  ...
  Future<void> _advanceMeetingTemplate({
