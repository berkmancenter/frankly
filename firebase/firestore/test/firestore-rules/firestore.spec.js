...
describe("Firestore security rules", () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("/publicUser/{userId}", () => {
      ...
      const communityRulesHelper =
        new firestore_rules_helper_1.CommunityRulesHelper(dbAdmin, [
      ...
      it("authorized, updating with same appRole", () =>
        __awaiter(void 0, void 0, void 0, function* () {
          const adminRoleDataMap = {
            appRole: "owner",
            otherField: "otherValue",
          };
          yield communityRulesHelper
            .getDocumentRef(dbAdmin)
            .set(adminRoleDataMap);
          const user = getAuthedFirestore("alice");
          const userColRef = communityRulesHelper.getCollectionRef(user);
          const userDocRef = communityRulesHelper.getDocumentRef(user);
          yield firebase.assertFails(userColRef.add(originalDataMap));
      ...
      it("authorized, updating with different appRole", () =>
        __awaiter(void 0, void 0, void 0, function* () {
          const adminRoleDataMap = {
            appRole: "user",
            otherField: "otherValue",
          ...
          it("update", () =>
            __awaiter(void 0, void 0, void 0, function* () {
              ...
              yield communityRulesHelper
                .getDocumentRef(dbAdmin)
                .set({ someKey: "value" });
              for (const membership of Object.keys(
                firestore_rules_helper_1.Membership,
              )) {
                yield communityRulesHelper.createMembership(
                  "alice",
                  membership,
                );
                switch (membership) {
        ...
        describe("/events/{eventId}", () => {
              ...
              __awaiter(void 0, void 0, void 0, function* () {
                it("isDocCreator", () =>
                  __awaiter(void 0, void 0, void 0, function* () {
                    const user = getAuthedFirestore("alice");
                    const userDocRef =
                      communityRulesHelper.getDocumentRef(user);
                    yield communityRulesHelper.getDocumentRef(dbAdmin).set({
                      [fieldCreatorId]: "alice",
                      someKey: "someValue",
                    });
          ...
          describe("/event-participants/{participantId}", () => {
            ...
            it("isDocCreator", () =>
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                const eventsHelper =
                  new firestore_rules_helper_1.CommunityRulesHelper(dbAdmin, [
                    {
                      collection: collectionCommunity,
            ...
            describe("request by uid", () => {
              it("request by same user", () =>
                __awaiter(void 0, void 0, void 0, function* () {
                  const user = getAuthedFirestore("eventParticipantId");
                  const userColRef =
                    communityRulesHelper.getCollectionRef(user);
                  const userDocRef = communityRulesHelper.getDocumentRef(user);
                  yield firebase.assertFails(userColRef.add(originalDataMap));
                  yield firebase.assertSucceeds(userDocRef.get());
                  yield firebase.assertSucceeds(
            ...
            it("facilitator updating status to banned", () =>
              __awaiter(void 0, void 0, void 0, function* () {
            ...
            it("facilitator updating lastUpdatedTime and status to banned ", () =>
              __awaiter(void 0, void 0, void 0, function* () {
                const statusDataMap = {
                  status: "banned",
                  lastUpdatedTime: "123",
            ...
            it("!isLiveStream", () =>
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield eventsHelper.updateDocumentsField({
                  liveStreamInfo: null,
                });
                yield communityRulesHelper
                  .getDocumentRef(dbAdmin)
          ...
          describe("/chats/{messageId=**}", () => {
            ...
            describe("authorized", () => {
              ...
              it("isParticipant", () =>
                __awaiter(void 0, void 0, void 0, function* () {
                  yield communityRulesHelper.makeParticipant(
                    "communityId",
                    "templateId",
                    "eventId",
                    "alice",
          ...
          describe("/user-suggestions/{suggestionId=**}", () => {
            ...
            const communityRulesHelper =
              new firestore_rules_helper_1.CommunityRulesHelper(dbAdmin, [
                ...
                { collection: collectionEvents, document: "eventId" },
                {
                  collection: collectionUserSuggestions,
