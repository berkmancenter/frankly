...
void main() {
  ...
  setUp(() {
    responsiveLayoutService = ResponsiveLayoutService(mediaQueryData: mockMediaQueryData);
  });
  ...
  test('isMaxSupportedMobileSize', () {
    ...
    expect(responsiveLayoutService.isMaxSupportedMobileSize(mockBuildContext), isTrue);
    ...
    expect(responsiveLayoutService.isMaxSupportedMobileSize(mockBuildContext), isFalse);
  ...
  group('getDynamicSize', () {
    test('isMobile', () {
      ...
      expect(responsiveLayoutService.getDynamicSize(mockBuildContext, 30, scale: 4 / 3), 40);
    });
    ...
    test('!isMobile', () {
      ...
      expect(responsiveLayoutService.getDynamicSize(mockBuildContext, 30, scale: 4 / 3), 30);
    });
  });
}
