...
/// Build app with Text widget inside a JuntoStreamGetterBuilder
Widget makeWidgets({required String text, required List<String> keys}) => MaterialApp(
      home: JuntoStreamGetterBuilder<String>(
...
String? getTextData(WidgetTester tester) => tester.widget<Text>(find.byKey(Key('text'))).data;
