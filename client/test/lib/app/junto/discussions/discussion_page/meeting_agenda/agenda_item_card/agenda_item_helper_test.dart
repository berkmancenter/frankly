...
void main() {
  final MockMeetingGuideCardStore mockMeetingGuideCardStore = MockMeetingGuideCardStore();
  ...
  group('isBrandNew', () {
    ...
    test('false, video', () {
      final model = AgendaItemModel(AgendaItem(id: ''));
      model.agendaItemTextData = AgendaItemTextData('', '');
      model.agendaItemVideoData = AgendaItemVideoData('', AgendaItemVideoType.url, 'video');
      model.agendaItemImageData = AgendaItemImageData('', '');
      model.agendaItemPollData = AgendaItemPollData('', []);
      model.agendaItemWordCloudData = AgendaItemWordCloudData('');
      model.agendaItemUserSuggestionsData = AgendaItemUserSuggestionsData('');
    ...
    test('false, suggestions', () {
      ...
      model.agendaItemPollData = AgendaItemPollData('', []);
      model.agendaItemWordCloudData = AgendaItemWordCloudData('');
      model.agendaItemUserSuggestionsData = AgendaItemUserSuggestionsData('suggestion');
  ...
  group('isPlayingVideo', () {
    ...
    test('playingVideo && inLiveMeeting', () {
      ...
      expect(helper.isPlayingVideo(mockMeetingGuideCardStore, mockAgendaProvider), isTrue);
    });
    ...
    test('playingVideo && !inLiveMeeting', () {
      ...
      expect(helper.isPlayingVideo(mockMeetingGuideCardStore, mockAgendaProvider), isFalse);
    });
    ...
    group('video', () {
      group('title', () {
        ...
        test('false', () {
          ...
          model.agendaItemVideoData = AgendaItemVideoData('title', AgendaItemVideoType.url, '');
      ...
      group('videoType', () {
        test('true', () {
          ...
          model.agendaItemVideoData = AgendaItemVideoData('', AgendaItemVideoType.vimeo, '');
      ...
      group('url', () {
        ...
        test('false', () {
          ...
          model.agendaItemVideoData = AgendaItemVideoData('', AgendaItemVideoType.url, 'videoUrl');
  ...
  group('areRequiredFieldsInput', () {
    group('text', () {
      test('input', () {
        final model = AgendaItemModel(AgendaItem(id: '', nullableType: AgendaItemType.text));
    ...
    group('video', () {
      test('input', () {
        final model = AgendaItemModel(AgendaItem(id: '', nullableType: AgendaItemType.video));
      ...
      group('not input', () {
        test('title', () {
          final model = AgendaItemModel(AgendaItem(id: '', nullableType: AgendaItemType.video));
          model.agendaItemVideoData = AgendaItemVideoData('', AgendaItemVideoType.url, 'url');
    ...
    group('image', () {
      test('input', () {
        final model = AgendaItemModel(AgendaItem(id: '', nullableType: AgendaItemType.image));
    ...
    group('poll', () {
      test('input', () {
        final model = AgendaItemModel(AgendaItem(id: '', nullableType: AgendaItemType.poll));
        model.agendaItemPollData = AgendaItemPollData('question', ['answer']);
    ...
    group('word cloud', () {
      test('input', () {
        final model = AgendaItemModel(AgendaItem(id: '', nullableType: AgendaItemType.wordCloud));
        model.agendaItemWordCloudData = AgendaItemWordCloudData('prompt');
