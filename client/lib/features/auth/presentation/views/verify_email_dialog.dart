...
class VerifyEmailDialog extends StatefulWidget {
 ...
 const VerifyEmailDialog({required this.email, Key? key}) : super(key: key);

 static Future<void> show({required String email}) async {
...
class _VerifyEmailDialogState extends State<VerifyEmailDialog> {
 ...
 Future<void> _checkVerification() async {
   ...
   await authMessageOnError(
     () async {
       await userService.firebaseAuth.currentUser?.reload();
       final verified =
