...
import 'meeting_template_card_item_video_contract.dart';
import '../../data/models/meeting_template_card_item_video_model.dart';
import '../meeting_template_card_item_video_presenter.dart';

class MeetingTemplateCardItemVideo extends StatefulWidget {
  @override
  _MeetingTemplateCardItemVideoState createState() =>
      _MeetingTemplateCardItemVideoState();
}

class _MeetingTemplateCardItemVideoState extends State<MeetingTemplateCardItemVideo>
    implements MeetingTemplateCardItemVideoView {
  late YoutubePlayerController _youtubePlayerController;
  late final MeetingTemplateCardItemVideoModel _model;
  late final MeetingTemplateCardItemVideoPresenter _presenter;

  @override
  void initState() {
    super.initState();

    _model = MeetingTemplateCardItemVideoModel();
    _presenter = MeetingTemplateCardItemVideoPresenter(context, this, _model);
  }
