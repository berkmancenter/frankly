...
class FirestoreMeetingTemplateService {
  ...
  Future<void> addUserSuggestion({
    ...
    loggingService
        .log('FirestoreMeetingTemplateService.addUserSuggestion: Data: $dataMap');
  ...
  Future<void> removeUserSuggestion({
    ...
    loggingService.log(
      'FirestoreMeetingTemplateService.removeUserSuggestion: Data: $dataMap',
    );
  ...
  Future<void> toggleLikeInMeetingSuggestion(
    ...
    loggingService.log(
      'FirestoreMeetingTemplateService.toggleLikeInMeetingSuggestion: Meta: ${participantAgendaItemDetailsMeta.toJson()}',
    );
  ...
  Future<void> toggleHandRaise({
    ...
    loggingService
        .log('FirestoreMeetingTemplateService.toggleHandRaise: Data: $updateMap');
