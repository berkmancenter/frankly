...
import 'meeting_template_card_item_user_suggestions_contract.dart';
import '../../data/models/meeting_template_card_item_user_suggestions_model.dart';
import '../meeting_template_card_item_user_suggestions_presenter.dart';

class MeetingTemplateCardItemUserSuggestions extends StatefulWidget {
  const MeetingTemplateCardItemUserSuggestions({Key? key}) : super(key: key);

  @override
  _MeetingTemplateCardItemUserSuggestionsState createState() =>
      _MeetingTemplateCardItemUserSuggestionsState();
}

class _MeetingTemplateCardItemUserSuggestionsState
    extends State<MeetingTemplateCardItemUserSuggestions>
    implements MeetingTemplateCardItemUserSuggestionsView {
  final _textEditingController = TextEditingController();
  late final MeetingTemplateCardItemUserSuggestionsModel _model;
  late final MeetingTemplateCardItemUserSuggestionsPresenter _presenter;
  ...
  void initState() {
    ...
    _model = MeetingTemplateCardItemUserSuggestionsModel();
    _presenter =
        MeetingTemplateCardItemUserSuggestionsPresenter(context, this, _model);
  }
            ...
            children: [
              Expanded(
                child: CustomStreamBuilder<List<ParticipantAgendaItemDetails>>(
                  entryFrom:
                      '_MeetingTemplateCardItemUserSuggestionsCloudState.build',
