...
import 'meeting_template_card_item_poll_contract.dart';
import '../../data/models/meeting_template_card_item_poll_model.dart';
import '../meeting_template_card_item_poll_presenter.dart';

class MeetingTemplateCardItemPoll extends StatefulWidget {
  @override
  State<MeetingTemplateCardItemPoll> createState() =>
      _MeetingTemplateCardItemPollState();
}

class _MeetingTemplateCardItemPollState extends State<MeetingTemplateCardItemPoll>
    implements MeetingTemplateCardItemPollView {
  late final MeetingTemplateCardItemPollModel _model;
  late final MeetingTemplateCardItemPollPresenter _presenter;

  @override
  void initState() {
    super.initState();

    _model = MeetingTemplateCardItemPollModel();
    _presenter = MeetingTemplateCardItemPollPresenter(context, this, _model);
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (agendaItem == null) {
      loggingService.log(
        '_MeetingTemplateCardItemPollState.build: AgendaItem is null',
    ...
    return CustomStreamBuilder<List<ParticipantAgendaItemDetails>>(
      entryFrom: '_MeetingTemplateCardItemPollState.build',
