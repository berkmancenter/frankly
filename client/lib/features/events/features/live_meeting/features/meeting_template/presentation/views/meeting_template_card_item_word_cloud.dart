...
import 'meeting_template_card_item_word_cloud_contract.dart';
import '../../data/models/meeting_template_card_item_word_cloud_model.dart';
import '../meeting_template_card_item_word_cloud_presenter.dart';

class MeetingTemplateCardItemWordCloud extends StatefulWidget {
  const MeetingTemplateCardItemWordCloud({Key? key}) : super(key: key);

  @override
  _MeetingTemplateCardItemWordCloudState createState() =>
      _MeetingTemplateCardItemWordCloudState();
}

class _MeetingTemplateCardItemWordCloudState
    extends State<MeetingTemplateCardItemWordCloud>
    implements MeetingTemplateCardItemWordCloudView {
  final FocusNode _wordCloudResponseFocusNode = FocusNode();
  final TextEditingController _wordCloudResponseController =
      TextEditingController(text: '');

  late final MeetingTemplateCardItemWordCloudModel _model;
  late final MeetingTemplateCardItemWordCloudPresenter _presenter;

  @override
  void initState() {
    super.initState();

    _model = MeetingTemplateCardItemWordCloudModel();
    _presenter = MeetingTemplateCardItemWordCloudPresenter(context, this, _model);
  }
    ...
    return MemoizedBuilder<Stream<List<ParticipantAgendaItemDetails>>?>(
      ...
      builder: (context, stream) {
        return CustomStreamBuilder<List<ParticipantAgendaItemDetails>>(
          entryFrom: '_MeetingTemplateCardState._buildWordCloudContent',
          stream: stream,
