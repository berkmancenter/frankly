...
import 'meeting_template_minimized_card_contract.dart';
import '../../data/models/meeting_template_minimized_card_model.dart';
import '../meeting_template_minimized_card_presenter.dart';

class MeetingTemplateMinimizedCard extends StatefulWidget {
  final void Function() onExpandCard;

  const MeetingTemplateMinimizedCard({Key? key, required this.onExpandCard})
      : super(key: key);

  @override
  State<MeetingTemplateMinimizedCard> createState() =>
      _MeetingTemplateMinimizedCardState();
}

class _MeetingTemplateMinimizedCardState extends State<MeetingTemplateMinimizedCard>
    implements MeetingTemplateMinimizedCardView {
  late final MeetingTemplateMinimizedCardModel _model;
  late final MeetingTemplateMinimizedCardPresenter _presenter;

  @override
  void initState() {
    super.initState();

    _model = MeetingTemplateMinimizedCardModel();
    _presenter = MeetingTemplateMinimizedCardPresenter(context, this, _model);
  }
        ...
        children: [
          ...
          if (currentItemId != null && showNextButton)
            CustomStreamBuilder<List<ParticipantAgendaItemDetails>>(
              entryFrom: '_MeetingTemplateMinimizedCardState.build',
