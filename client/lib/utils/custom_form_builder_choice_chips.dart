...
class CustomFormBuilderChoiceChip<T> extends FormBuilderField<T> {
                      ...
                      return FormBuilderFieldOption(
                        ...
                        child: Padding(
                          ...
                          child: DottedBorder(
                            ...
                            color: field.value == option.value ? selectedColor : Colors.grey,
                            dashPattern: field.value == option.value ? const [1, 0] : const [5, 5],
                            strokeWidth: 1,
                            child: ChoiceChip(
                              label: option,
                              ...
                              labelStyle: field.value == option.value
                                  ? labelStyle.copyWith(color: AppColor.darkBlue)
                                  : labelStyle,
  ...
  @override
  _CustomFormBuilderChoiceChipState<T> createState() => _CustomFormBuilderChoiceChipState<T>();
}
