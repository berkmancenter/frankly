...
class JuntoText extends StatelessWidget {
  final String text;
  ...
  Widget build(BuildContext context) {
    var textStyle =
        GoogleFonts.poppins().merge(DefaultTextStyle.of(context).style).merge(style ?? TextStyle());

    textStyle = textStyle.copyWith(color: textStyle.color ?? Theme.of(context).primaryColor);
    ...
    if (localMaxLines != null && localFontSize != null && localHeight != null) {
      ...
      return ConstrainedBox(
        constraints: BoxConstraints(maxHeight: localFontSize * localHeight * localMaxLines),
        child: Text(
          text,
          textAlign: textAlign,
          style: textStyle,
