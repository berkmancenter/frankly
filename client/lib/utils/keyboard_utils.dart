...
class FocusFixer extends StatelessWidget {
  ...
  Widget _unfocusOnKeyboardDismissIfTrue({required Widget child}) =>
      unfocusOnKeyboardDismiss ? _UnfocusOnKeyboardDismiss(child: child) : child;
...
class _UnfocusOnKeyboardDismiss extends StatefulWidget {
  ...
  const _UnfocusOnKeyboardDismiss({required this.child, Key? key}) : super(key: key);

  @override
  _UnfocusOnKeyboardDismissState createState() => _UnfocusOnKeyboardDismissState();
}
