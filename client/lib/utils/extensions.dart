...
export 'package:junto_models/firestore/discussion.dart';
export 'package:junto_models/firestore/emotion.dart';
...
extension DurationExtension on Duration {
  ...
  String getFormattedTime({
    ...
    if (!showHours && !showMinutes && !showSeconds) {
      throw AssertionError('showHours or showMinutes or showSeconds must be true');
    }
