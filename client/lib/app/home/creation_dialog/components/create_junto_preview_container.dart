...
class PreviewContainer extends StatelessWidget {
  ...
  Color get _containerColor => finalPreview
      ? (ThemeUtils.parseColor(junto.themeLightColor) ?? AppColor.gray6)
      : AppColor.gray6;

  Color get _carouselColor => finalPreview
      ? (ThemeUtils.parseColor(junto.themeDarkColor) ?? AppColor.darkBlue)
      : AppColor.gray4;

  Color get _nameColor => finalPreview
      ? (ThemeUtils.parseColor(junto.themeDarkColor) ?? AppColor.darkBlue)
      : !isNullOrEmpty(junto.name)
          ? AppColor.darkBlue
          : AppColor.gray4;

  Color get _taglineColor => finalPreview
      ? AppColor.white
      : !isNullOrEmpty(junto.tagLine)
          ? AppColor.white
          : AppColor.gray3;

  Color get _aboutColor => finalPreview
      ? (ThemeUtils.parseColor(junto.themeDarkColor) ?? AppColor.darkBlue)
      : !isNullOrEmpty(junto.description)
          ? AppColor.darkBlue
          : AppColor.gray4;
            ...
            children: [
              ...
              for (int i = 0; i < 3; i++) ...[
                ...
                Container(
                  ...
                  height: 29,
                  decoration:
                      BoxDecoration(borderRadius: BorderRadius.circular(5), color: AppColor.white),
                ),
              ]
            ],
          ),
  ...
  Widget _buildLogo({Color color = AppColor.gray4}) => !isNullOrEmpty(junto.profileImageUrl)
      ? JuntoImage(
  ...
  Widget _buildCarousel() => Container(
        ...
        child: Stack(
          ...
          fit: StackFit.expand,
          children: [
            if (!isNullOrEmpty(junto.bannerImageUrl)) ...[
              JuntoImage(
  ...
  Widget _buildLineMock(double width, {Color color = AppColor.gray4}) => Container(
        width: width,
        height: 4,
        decoration: BoxDecoration(
...
class _EmphasisAnimationState extends State<EmphasisAnimation> with SingleTickerProviderStateMixin {
