...
import 'package:client/app/home/creation_dialog/components/choose_color_section.dart';
import 'package:client/app/home/creation_dialog/components/create_community_image_fields.dart';
import 'package:client/app/home/creation_dialog/components/create_community_preview_container.dart';
import 'package:client/app/home/creation_dialog/components/create_community_tags.dart';
import 'package:client/app/home/creation_dialog/components/create_community_text_fields.dart';
import 'package:client/app/home/creation_dialog/components/private_community_checkbox.dart';
...
import 'package:client/common_widgets/upgrade_icon.dart';
...
class _FreemiumDialogFlowState extends State<FreemiumDialogFlow> {
  ...
  Future<bool> _nextButtonAction() async {
    if (_onStep == 1) {
      ...
      if (_createCommunity) {
        _createdCommunityId = (await cloudFunctionsService
