...
import 'package:client/app/home/creation_dialog/components/upgrade_perks.dart';
...
import 'package:client/common_widgets/confirm_dialog_white.dart';
import 'package:client/common_widgets/profile_chip.dart';
  ...
  Future<void> _updatePlanPressed() async {
    ...
    if (_selectedPlan.typeCode == _customSubscriptionType) {
      ...
      if (selectedPlanType != null) {
        final priceInfo =
            await cloudFunctionsService.getStripeSubscriptionPlanInfo(
        ...
        if (confirm) {
          await cloudFunctionsService.updateStripeSubscriptionPlan(
        ...
        if (_selectedPlan.typeCode == _freeSubscriptionType) {
          ...
          if (confirm) {
            await cloudFunctionsService.cancelStripeSubscriptionPlan(
      ...
      if (selectedPlanType != null) {
        final response =
            await cloudFunctionsService.createSubscriptionCheckoutSession(
          ...
          children: [
            ...
            ActionButton(
              ...
              onPressed: () async {
                final community = context.read<CommunityProvider>().community;
                final response =
                    await cloudFunctionsService.getStripeBillingPortalLink(
