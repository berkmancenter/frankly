...
import 'package:client/common_widgets/custom_switch_tile.dart';
...
class _SettingsTabState extends State<SettingsTab> {
  ...
  Future<void> _toggleCommunitySetting(CommunitySettings communitySettings) {
    return cloudFunctionsService.updateCommunity(
  ...
  Future<void> _stripeButtonPressed(PartnerAgreement agreement) async {
    ...
    if (agreement.stripeConnectedAccountId == null) {
      final accepted =
          await Dialogs.showAcceptTakeRateDialog(context, communityProvider);
      if (!accepted) {
        return;
      }
