...
import 'package:client/app/community/events/event_page/live_meeting/meeting_rating.dart';
...
import 'package:client/utils/hostless_action_fallback_controller.dart';
...
class LiveMeetingProvider with ChangeNotifier {
    ...
    if (!timeUntilWaitingRoomFinished.isNegative &&
      ...
      _hostlessGoToBreakoutsFallbackController =
        ...
        action: () async {
          ...
          await cloudFunctionsService.checkHostlessGoToBreakouts(
      ...
      if (timeUntilBreakouts != null) {
        ...
        _pendingBreakoutsFallbackController = HostlessActionFallbackController(
          ...
          action: () async {
            ...
            await cloudFunctionsService.checkAssignToBreakouts(
  ...
  Future<GetMeetingJoinInfoResponse> getMeetingJoinInfo() {
    ...
    return cloudFunctionsService.getMeetingJoinInfo(
  ...
  Future<BreakoutRoom> reassignBreakoutRoom({
    ...
    return cloudFunctionsService.reassignBreakoutRoom(
    ...
    if (localOnLeave != null) {
      ...
      if (prePostEnabled && postEventCardData != null) {
        if (timeNow.difference(event.scheduledTime ?? timeNow).inMinutes >
          ...
          unawaited(
            cloudFunctionsService.eventEnded(
  ...
  Future<GetMeetingJoinInfoResponse> getBreakoutRoomFuture({
    ...
    final breakoutRoomJoinInfo = cloudFunctionsService.getBreakoutRoomJoinInfo(
