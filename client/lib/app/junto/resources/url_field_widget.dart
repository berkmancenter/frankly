          ...
          children: [
            Expanded(
              child: JuntoTextField(
                onEditingComplete:
                    url?.isNotEmpty == true && isNullOrEmpty(error) ? () => onSubmit() : null,
                hintText: 'Paste or enter a URL',
                initialValue: url,
                controller: controller,
                borderColor: (isNullOrEmpty(error) ? borderColor : AppColor.redDarkMode) ??
                    AppColor.darkBlue,
            ...
            if (isEdited) ...[
              ...
              JuntoInkWell(
                ...
                child: CircleAvatar(
                  radius: 25,
                  backgroundColor:
                      (isNullOrEmpty(error) ? buttonColor : AppColor.gray3) ?? AppColor.darkBlue,
                  child: Icon(
                    Icons.check,
