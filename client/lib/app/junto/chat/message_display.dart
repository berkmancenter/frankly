...
class MessageDisplayState extends State<MessageDisplay> {
  ...
  bool get _canDelete =>
      DiscussionPermissionsProvider.watch(context)?.canDeleteDiscussionMessage(widget.message) ??
      context.watch<CommunityPermissionsProvider>().canDeleteChatMessage(widget.message);

  bool get _removed => widget.message.messageStatus == ChatMessageStatus.removed;
                      ...
                      children: [
                          ...
                          children: [
                            SelectableText(
                              ...
                              style: TextStyle(
                                ...
                                color:
                                    Theme.of(context).isDark ? AppColor.gray5 : AppColor.darkBlue,
                              ),
                            ),
                            SelectableText(
                        ...
                        if (_removed)
                          JuntoText(
                            ...
                            style: TextStyle(
                              color: Theme.of(context).isDark ? AppColor.gray5 : AppColor.gray1,
                              fontSize: 13,
                          ...
                          Semantics(
                            ...
                            child: SelectableLinkify(
                              ...
                              style: TextStyle(
                                fontSize: 15,
                                color:
                                    Theme.of(context).isDark ? AppColor.white : AppColor.darkBlue,
                              ),
                  ...
                  if (!_removed && _canDelete)
                    JuntoInkWell(
                      ...
                      child: Padding(
                        ...
                        child: Icon(
                          Icons.close,
                          color: Theme.of(context).isDark ? AppColor.gray6 : AppColor.darkBlue,
                          size: 20,
                        ),
                      ),
                    ),
