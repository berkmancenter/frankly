...
class ImageCarousel extends StatelessWidget {
  ...
  bool _showFullImageShade(int index) =>
      imageToDarkenFully == orderedImageUrls[index] && orderedImageUrls[index]?.isNotEmpty == true;
  ...
  Widget _buildSingleImage(double size) {
    // Single item is Frankly page description
    final _image = orderedImageUrls.first;
    return _CarouselImageBox(
      size: size,
      opacity: 1,
      fullOverlay: true,
      showOverlay: orderedImageUrls.firstOrNull?.isNotEmpty == true,
      child: _CarouselJuntoImage(_image),
    );
  }
                  ...
                  child: Row(
                    ...
                    children: [
                      _CarouselImageBox(
                        ...
                        size: size,
                        child: _CarouselJuntoImage(orderedImageUrls[0]),
                      ...
                      _CarouselImageBox(
                        opacity: reverseAnimation
                            ...
                            : .2 + (imageAnimationController.value * .8).abs(),
                        size: size,
                        child: JuntoImage(orderedImageUrls[1]),
        ...
        return Center(
          child: SizedBox(
            ...
            child: SingleChildScrollView(
              ...
              physics: NeverScrollableScrollPhysics(),
              child: Transform.translate(
                offset: Offset(-size * imageAnimationController.value - size * 2, 0),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    _CarouselImageBox(
                    ...
                    _CarouselImageBox(
                      opacity: .2 - (imageAnimationController.value * .8).clamp(-1, 0),
                      size: size,
                      child: _CarouselJuntoImage(orderedImageUrls[1]),
                      fullOverlay: _showFullImageShade(1),
                    ),
                    _CarouselImageBox(
                      opacity: 1 - (imageAnimationController.value * .8).abs(),
                      size: size,
                      child: _CarouselJuntoImage(orderedImageUrls[2]),
                      fullOverlay: _showFullImageShade(2),
                    ),
                    _CarouselImageBox(
                      opacity: .2 + (imageAnimationController.value * .8).clamp(0, 1),
                      size: size,
                      child: _CarouselJuntoImage(orderedImageUrls[3 % _length]),
                      fullOverlay: _showFullImageShade(3 % _length),
                    ),
                    _CarouselImageBox(
                      opacity: .2,
                      size: size,
                      child: _CarouselJuntoImage(orderedImageUrls[4 % _length]),
...
class _CarouselJuntoImage extends StatelessWidget {
  final String? url;

  const _CarouselJuntoImage(
    this.url, {
    Key? key,
  }) : super(key: key);
