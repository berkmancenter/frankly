...
class CanvasKitUrlVideoWidget extends StatefulWidget {
  ...
  @override
  _CanvasKitUrlVideoWidgetState createState() => _CanvasKitUrlVideoWidgetState();
}
...
class _CanvasKitUrlVideoWidgetState extends State<CanvasKitUrlVideoWidget> {
  ...
  void initState() {
    ...
    registerWebViewFactory(_viewType, (_) {
      ...
      localDiv.append(html.VideoElement()
        ..id = 'video-js-element'
        ..style.width = '100%'
        ..style.height = '100%'
    ...
    Future.delayed(
        ...
        () => WidgetsBinding.instance?.addPostFrameCallback((_) => universal_js.context.callMethod(
              'playVideoJs',
              [
                'video-js-element',
                widget.playbackUrl,
