...
class _AgendaItemVideoState extends State<AgendaItemVideo>
  ...
  void _init() {
    _model = AgendaItemVideoModel(widget.isEditMode, widget.agendaItemVideoData, widget.onChanged);
  ...
  void initState() {
    ...
    _textEditingController = TextEditingController(text: widget.agendaItemVideoData.url);
    _init();
  }
          ...
          children: [
            ...
            Row(
              children: List.generate(_agendaItemVideoTabTypes.length, (index) {
                ...
                final isSelected = _model.agendaItemVideoTabType == agendaItemVideoTabType;
  ...
  Widget _buildVideoPicker(String text) {
    return ActionButton(
      ...
      text: text,
      onPressed: () async {
        final url = await GetIt.instance<MediaHelperService>().pickVideoViaCloudinary();
        if (url != null) {
          _updateTextInController(url);
          ...
          children: [
            Expanded(
              child: JuntoTextField(
                ...
                maxLines: null,
                textStyle: AppTextStyle.bodyMedium.copyWith(color: AppColor.darkBlue),
                hintStyle: AppTextStyle.bodyMedium.copyWith(color: AppColor.gray2),
