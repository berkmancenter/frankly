...
import 'package:junto/app/junto/discussions/discussion_page/meeting_agenda/agenda_item_card/items/poll/agenda_item_poll_model.dart';
...
class _AgendaItemPollState extends State<AgendaItemPoll> implements AgendaItemPollView {
  late AgendaItemPollModel _model;
  late AgendaItemPollPresenter _presenter;

  void _init() {
    _model = AgendaItemPollModel(widget.isEditMode, widget.agendaItemPollData, widget.onChanged);
