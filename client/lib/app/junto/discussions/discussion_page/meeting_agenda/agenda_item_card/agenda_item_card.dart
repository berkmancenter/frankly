...
import 'package:junto/app/junto/discussions/discussion_page/meeting_agenda/agenda_item_card/items/image/agenda_item_image.dart';
import 'package:junto/app/junto/discussions/discussion_page/meeting_agenda/agenda_item_card/items/poll/agenda_item_poll.dart';
import 'package:junto/app/junto/discussions/discussion_page/meeting_agenda/agenda_item_card/items/text/agenda_item_text.dart';
import 'package:junto/app/junto/discussions/discussion_page/meeting_agenda/agenda_item_card/items/user_suggestions/agenda_item_user_suggestions.dart';
...
import 'package:junto/app/junto/discussions/discussion_page/meeting_agenda/agenda_item_card/items/word_cloud/agenda_item_word_cloud.dart';
...
import 'package:junto/common_widgets/time_input_form.dart';
...
class _AgendaItemCardState extends State<AgendaItemCard> implements AgendaItemView {
  ...
  Widget _buildTopSection() {
    ...
    final canReorder = _presenter.canReorder(allowEdit, isEditMode, isCompleted, isCardActive);
    final agendaItemType = _model.agendaItem.type;
    final title = _presenter.getTitle();
    final formattedTime =
        Duration(seconds: _model.agendaItem.timeInSeconds ?? 0).getFormattedTime(showHours: false);
            ...
            Wrap(
              ...
              children: [
                ...
                TimeInputForm(
                  ...
                  duration: Duration(
                    seconds: _model.agendaItem.timeInSeconds ?? AgendaItem.kDefaultTimeInSeconds,
                  ),
    ...
    return Container(
      ...
      child: DropdownButton<AgendaItemType>(
          ...
          onChanged: (AgendaItemType? agendaItemType) async {
            if (agendaItemType != null && _model.agendaItem.type != agendaItemType) {
    ...
    switch (agendaItemType) {
      ...
      case AgendaItemType.userSuggestions:
        return AgendaItemUserSuggestions(
          ...
          onChanged: (data) => _presenter.updateAgendaItemUserSuggestionsData(data),
        );
    }
  }
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: _model.isEditMode ? _buildEditBottomSection() : _buildPreviewBottomSection(),
        ),
      ],
    );
  }
  ...
  Future<void> _showDeleteDialog() async {
    final delete = await ConfirmDialog(
            title: 'Delete Agenda Item', mainText: 'Are you sure you want to delete?')
      ...
      child: Row(
        children: [
          ...
          FloatingActionButton(
            ...
            elevation: 0,
            materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
            backgroundColor: hasBeenEdited || isCardUnsaved ? AppColor.darkBlue : AppColor.gray6,
            child: Icon(
              Icons.check,
              color: hasBeenEdited || isCardUnsaved ? AppColor.white : AppColor.gray4,
            ),
