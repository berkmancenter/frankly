...
class _UserSubmittedAgendaState extends State<UserSubmittedAgenda> {
  UserSubmittedAgendaProvider get provider => Provider.of<UserSubmittedAgendaProvider>(context);
  ...
  Widget _buildItem(SuggestedAgendaItem item) {
    ...
    final canDelete =
        Provider.of<DiscussionPermissionsProvider>(context).canDeleteSuggestedItem(item);
  ...
  Widget _buildContent() {
    return JuntoStreamBuilder<List<SuggestedAgendaItem>>(
        ...
        children: [
          Expanded(
            child: JuntoTextField(
              ...
              onEditingComplete: canSubmit ? () => _submitController.submit() : null,
          ...
          ActionButton(
            ...
            onPressed: canSubmit ? () => alertOnError(context, () => readProvider.submit()) : null,
