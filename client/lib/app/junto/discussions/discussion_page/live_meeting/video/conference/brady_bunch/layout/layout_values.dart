...
class BradyBunchLayoutValues {
  ...
  BradyBunchLayoutValues withBradyCount(int numBradys) => BradyBunchLayoutValues(
      totalHeight: totalHeight, totalWidth: totalWidth, numBradys: numBradys);
  ...
  @override
  String toString() => '(Values) width: $totalWidth, height: $totalHeight, bradys: $numBradys';
}
