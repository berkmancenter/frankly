...
class BradyBunchLayoutParameters {
  ...
  BradyBunchLayoutParameters withAspectRatio(double ratio) => BradyBunchLayoutParameters(
        rows: rows,
        columns: columns,
  ...
  @override
  String toString() => '(Parameters) rows: $rows, columns: $columns, rect: $aspectRatio';
}
