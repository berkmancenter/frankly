...
import 'package:junto/app/junto/discussions/discussion_page/live_meeting/video/widget/custom_page_view_builder.dart';
...
class _BradyBunchViewWidgetState extends State<BradyBunchViewWidget> {
  ...
  List<AgoraParticipant> get participants => ConferenceRoom.watch(context).participants;
  ...
  Widget _buildPageView() {
    return LayoutBuilder(
      builder: (context, constraints) => PageView.builder(
        ...
        itemBuilder: (BuildContext context, int index) => _buildParticipantPage(index),
    ...
    return RepaintBoundary(
      child: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          final participantsOnThisPageStartIndex = pageIndex * _maxParticipantsPerPage;
...
class BradyBunchLayoutWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final BradyBunchLayout layout = BradyBunchLayout.calculateOptimalLayout(
        width: width, height: height, participantCount: pageParticipants.length);
                      ...
                      Flexible(
                        child: AspectRatio(
                          ...
                          child: ParticipantWidget(
                            ...
                            globalKey: JuntoGlobalKey.fromLabel(participantAtIndex(i, j).userId),
