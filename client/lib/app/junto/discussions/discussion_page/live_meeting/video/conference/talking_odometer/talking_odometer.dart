...
import 'package:junto/app/junto/discussions/discussion_page/live_meeting/video/conference/talking_odometer/talking_odometer_presenter.dart';
...
class _TalkingOdometerState extends State<TalkingOdometer>
  ...
  void initState() {
    ...
    _presenter.init();
    _warningController = AnimationController(vsync: this, duration: bounceDuration);
  }
  ...
  Widget _buildContent() {
    ...
    final double adjustedValue = (value * .8) + (value * .2 * pow(_warningController.value, 2));
    ...
    return Center(
      child: Tooltip(
        ...
        child: ColorfulMeterV2(
          ...
          title: _presenter.userTotalTalkingTime.getFormattedTime(showHours: false),
          subtitle: 'mins',
        ),
      ),
    );
