...
class _MeetingGuideTutorialState extends State<MeetingGuideTutorial> {
    ...
    return ConstrainedBox(
      ...
      child: Stack(
        ...
        children: [
          Padding(
            padding:
                isMobile ? EdgeInsets.zero : EdgeInsets.symmetric(vertical: 100, horizontal: 125),
            child: ClipRRect(
          ...
          if (canShowTutorialTextArrowSectionOutside) _buildTutorialHelperOutside()
        ],
      ),
    );
  }
  ...
  double _getDynamicSize(double originalValue, {double scale = 2 / 3}) {
    final value = responsiveLayoutService.isMobile(context) ? originalValue * scale : originalValue;
        ...
        children: [
          Row(
            ...
            children: [
              ...
              IgnorePointer(
                ignoring: true,
                child: RaisingHandToggle(isHandRaised: false, isCardMinimized: false),
              ),
            ],
          ),
          SizedBox(height: 16),
        ...
        children: [
          ...
          Stack(
            ...
            children: [
              Align(
                child: Padding(
                  padding: const EdgeInsets.only(right: kEmptyProfileSize * 1.25),
              ...
              Align(
                child: Padding(
                  padding: const EdgeInsets.only(left: kEmptyProfileSize * 1.25),
                  child: _buildProfileImage(kEmptyProfileSize),
                ),
              ),
            ],
