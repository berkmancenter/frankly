...
class _PrePostCardWidgetPageState extends State<PrePostCardWidgetPage>
  ...
  void initState() {
    ...
    _model = PrePostCardWidgetModel(
        widget.prePostCardType, widget.discussion, widget.isEditable, widget.topic);
  ...
  Color get _textColor => widget.isWhiteBackground ? AppColor.darkBlue : AppColor.white;
  Color get _backgroundColor => widget.isWhiteBackground ? AppColor.white : AppColor.darkBlue;
  Color get _fillColor => widget.isWhiteBackground ? AppColor.white : AppColor.darkerBlue;
                        ...
                        children: [
                          ...
                          if (isEditIconShown)
                            IconButton(
                              ...
                              icon: Icon(CupertinoIcons.delete, color: _textColor),
  ...
  Widget _buildEditablePrePostCard() {
    ...
    final backgroundColor = widget.isWhiteBackground ? AppColor.white : AppColor.darkBlue;
    return Column(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 14),
              JuntoTextField(
                hintText: 'Enter Message. Eg, Take this survey $beforeAfter the event',
            ...
            Container(
              ...
              child: Center(
                child: AppClickableWidget(
                  ...
                  child: Icon(CupertinoIcons.delete, size: 15, color: _textColor),
                ),
              ),
            ),
            SizedBox(width: 20),
            CircleSaveCheckButton(
              isEnabled: _presenter.hasBeenEdited(widget.discussion),
              isWhiteBackground: widget.isWhiteBackground,
              onPressed: () {
  ...
  Widget _buildMobileActionLinks(int urlIndex) {
    ...
    if (urlIndex < prePostUrls.length) {
      availableAttributeTypes =
          _presenter.getAvailableAttributeTypes(prePostUrls[urlIndex].attributes);
      attributes = prePostUrls[urlIndex].attributes;
    }

    final String finalisedUrl = _presenter.getFinalisedUrl(prePostUrls[urlIndex]);
    final String finalisedUrlFieldValue = finalisedUrl.isEmpty ? 'URL invalid' : finalisedUrl;
    ...
    return Column(
      ...
      children: [
        ...
        if (availableAttributeTypes.isNotEmpty) _buildAddURLParameterButton(urlIndex),
      ],
    );
  }
      ...
      ListView.builder(
        ...
        itemBuilder: (context, attributeIndex) {
          ...
          return AttributeOption(
            ...
            attribute: attribute,
            innerAvailableAttributeTypes: _presenter.getInnerAvailableAttributeTypes(
              availableAttributeTypes,
              attribute.type,
            ),
            urlIndex: urlIndex,
            ...
            onUpdateEnteredQueryName: (value) {
              _presenter.updateEnteredQueryName(urlIndex, attributeIndex, attribute, value);
            },
            onUpdateAttributeTypeSelection: (type) {
              _presenter.updateAttributeTypeSelection(type, urlIndex, attributeIndex);
            },
          );
        },
      ),
        ...
        children: [
          ...
          if (prePostUrls.isNotEmpty)
            Wrap(
              spacing: 20,
              runSpacing: 15,
              children: [for (var urlInfo in prePostUrls) _buildLinkActionButton(urlInfo)],
            ),
        ],
      ),
    );
...
class _AttributeOptionState extends State<AttributeOption> {
  ...
  Color get _textColor => widget.isWhiteBackground ? AppColor.darkBlue : AppColor.white;
  Color get _backgroundColor => widget.isWhiteBackground ? AppColor.white : AppColor.darkerBlue;
  ...
  @override
  Widget build(BuildContext context) {
    return isEditMode ? _buildEditAttributeView() : _buildAttributeSelectedView();
  }
            ...
            children: [
              Expanded(
                child: JuntoTextField(
                  ...
                  maxLines: 1,
                  maxLength: 20,
                  onChanged: (_) => widget.onUpdateEnteredQueryName(_textController.text),
    ...
    return Container(
      ...
      child: DropdownButton<PrePostCardAttributeType>(
        ...
        items: innerAvailableAttributeTypes
            .map((e) => DropdownMenuItem<PrePostCardAttributeType>(
                  value: e,
