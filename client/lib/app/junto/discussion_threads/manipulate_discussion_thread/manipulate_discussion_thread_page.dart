...
class ManipulateDiscussionThreadPage extends StatefulWidget {
  ...
  @override
  _ManipulateDiscussionThreadPageState createState() => _ManipulateDiscussionThreadPageState();
}

class _ManipulateDiscussionThreadPageState extends State<ManipulateDiscussionThreadPage>
  ...
  void initState() {
    super.initState();
    _model = ManipulateDiscussionThreadModel(widget.juntoProvider, widget.discussionThread);
