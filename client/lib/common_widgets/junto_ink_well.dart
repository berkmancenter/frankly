...
class JuntoInkWell extends StatefulWidget {
  ...
  @override
  _JuntoInkWellState createState() => _JuntoInkWellState();
}

class _JuntoInkWellState extends State<JuntoInkWell> {
  var _hover = false;
  ...
  Widget build(BuildContext context) {
    ...
    Color hoverFillColor = widget.hoverColor ?? Theme.of(context).primaryColor.withOpacity(0.2);
