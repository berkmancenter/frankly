...
class _ConfirmDialogWhiteState extends State<ConfirmDialogWhite> {
  ...
  void initState() {
    ...
    ConfirmDialogWhite.confirmDialogDismisser.dismissNotifier.addListener(_closeDialog);
  }

  @override
  void dispose() {
    ConfirmDialogWhite.confirmDialogDismisser.dismissNotifier.removeListener(_closeDialog);
            ...
            child: JuntoListView(
              ...
              children: [
                ...
                ActionButton(
                  ...
                  textStyle: AppTextStyle.bodyMedium.copyWith(color: AppColor.brightGreen),
                ...
                if (!isNullOrEmpty(widget.cancelText))
                  ActionButton(
                    margin: EdgeInsets.symmetric(horizontal: 4).copyWith(top: 10),
                    expand: true,
                    height: 24,
                    color: Colors.transparent,
