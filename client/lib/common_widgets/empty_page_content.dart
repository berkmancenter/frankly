  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: showContainer
          ? BoxDecoration(borderRadius: BorderRadius.circular(10), color: AppColor.white)
          : null,
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: JuntoText(
              ...
              style: AppTextStyle.eyebrowSmall.copyWith(color: _getColor(subtitle: true)),
          ...
          if (onButtonPress != null)
            ActionButton(
              ...
              textStyle: AppTextStyle.body.copyWith(color: isFlat ? AppColor.white : buttonColor),
