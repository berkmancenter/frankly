...
class _ConfirmDialogState extends State<ConfirmDialog> {
  ...
  void initState() {
    ...
    ConfirmDialog.confirmDialogDismisser.dismissNotifier.addListener(_closeDialog);
  }

  @override
  void dispose() {
    ConfirmDialog.confirmDialogDismisser.dismissNotifier.removeListener(_closeDialog);

    super.dispose();
  }

  Color get textColor => widget.isWhiteBackground ? AppColor.darkBlue : AppColor.white;
  Color get buttonColor => widget.isWhiteBackground ? AppColor.darkBlue : AppColor.lightGreen;
  Color get backgroundColor => widget.isWhiteBackground ? AppColor.white : AppColor.darkBlue;

  Widget _buildDialog(BuildContext context) {
    final onCancel = widget.onCancel;
    final onConfirm = widget.onConfirm;

    return JuntoPointerInterceptor(
      child: Material(
