...
class JuntoTabBar extends StatelessWidget {
  final EdgeInsets? padding;
  final bool isWhiteBackground;

  const JuntoTabBar({Key? key, this.padding, this.isWhiteBackground = false, x});
            ...
            if (!tabController.tabs[i].isGated)
              Padding(
                ...
                child: JuntoInkWell(
                  ...
                  onTap: !tabController.tabs[i].isGated ? () => tabController.currentTab = i : null,
                  child: _JuntoTab(
...
class _JuntoTab extends StatefulWidget {
  final JuntoTabAndContent tab;
  final int index;
  ...
  @override
  State<_JuntoTab> createState() => _JuntoTabState();
}

class _JuntoTabState extends State<_JuntoTab> {
  bool _hovered = false;

  TextStyle get getTextStyle {
    final style =
        _hovered && widget.isWhiteBackground ? AppTextStyle.bodyMedium : AppTextStyle.body;
  ...
  Color get selectedColor => widget.isWhiteBackground ? AppColor.darkBlue : AppColor.brightGreen;
                    ...
                    children: [
                      ...
                      if (widget.isWhiteBackground)
                        JuntoText(
                          ...
                          style: AppTextStyle.bodyMedium.copyWith(color: Colors.transparent),
                        ),
                      JuntoText(
                        widget.tab.tab.toUpperCase(),
                        style: getTextStyle,
