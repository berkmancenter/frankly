...
class ResponsiveLayoutService {
  ...
  ResponsiveLayoutService({MediaQueryData? mediaQueryData}) : _mediaQueryData = mediaQueryData;

  bool isMobile(BuildContext context) {
    final MediaQueryData mediaQueryData = _mediaQueryData ?? MediaQuery.of(context);
