...
class MediaHelperService {
  static const defaultMediaPreset = 'evk17p8n';

  static const imageFormatDescription = 'image';
  static const videoExtensionsToTransform = ['mov', 'flv', 'mkv', 'ogv'];
  static const allowedVideoFormats = [...videoExtensionsToTransform, 'mp4', 'webm'];
  ...
  String? tryTransformVideoUrlToMp4(String? url) {
    if (url != null && videoExtensionsToTransform.any((ext) => url.endsWith(ext))) {
  ...
  Future<String?> pickVideoViaCloudinary() async {
    String? url = await pickMediaViaCloudinary(
      uploadPreset: defaultMediaPreset,
  ...
  Future<String?> pickImageViaCloudinary() {
    return pickMediaViaCloudinary(
      uploadPreset: 'cropping_image_preset',
  ...
  Future<String?> pickMediaViaCloudinary({
    ...
    List<String> clientAllowedFormats = const [imageFormatDescription, ...allowedVideoFormats],
    bool cropping = false,
    ...
    js_util.callMethod(html.window, 'pickMedia', [
      ...
      js.allowInterop((error, result) {
        loggingService.log('Image Picker result Error: $error, Result: $result');
        ...
        if (error != null) {
          ...
          try {
            ...
            //{"info":{"files":[{"id":"uw-file3","batchId":"uw-batch2","name":"nyan-cat-4k.gif","size":0,"type":"","imageDimensions":[],"status":"success","progress":100,"done":true,"failed":false,"aborted":false,"paused":false,"partOfBatch":false,"publicId":"","preparedParams":{},"camera":false,"coordinatesResize":false,"delayedPreCalls":false,"publicIdCounter":-1,"isFetch":true,"statusText":"success","uploadInfo":{"asset_id":"2448ddf3f766f70f1e477313671fb488","public_id":"nyan-cat-4k_epljbh","version":1636362311,"version_id":"8afdf8293dc8211de2be1315b37d1ab2","signature":"77e182747682e38c8bfc3543357cefb617a8bb2c","width":220,"height":124,"format":"gif","resource_type":"image","created_at":"2021-11-08T09:05:11Z","tags":[],"pages":24,"bytes":35477,"type":"upload","etag":"5e7895f961693adc6b76729f12fdecd3","placeholder":false,"url":"http://res.cloudinary.com/junto/image/upload/v1636362311/nyan-cat-4k_epljbh.gif","secure_url":"https://res.cloudinary.com/junto/image/upload/v1636362311/nyan-cat-4k_epljbh.gif","access_mode":"public","existing":false,"original_filename":"nyan-cat-4k","path":"v1636362311/nyan-cat-4k_epljbh.gif","thumbnail_url":"https://res.cloudinary.com/junto/image/upload/c_limit,h_60,w_90/v1636362311/nyan-cat-4k_epljbh.jpg"}}]},"event":"queues-end","uw_event":true,"data":{"type":"uw_event","widgetId":"widget_9","event":"queues-end","info":{"files":[{"id":"uw-file3","batchId":"uw-batch2","name":"nyan-cat-4k.gif","size":0,"type":"","imageDimensions":[],"status":"success","progress":100,"done":true,"failed":false,"aborted":false,"paused":false,"partOfBatch":false,"publicId":"","preparedParams":{},"camera":false,"coordinatesResize":false,"delayedPreCalls":false,"publicIdCounter":-1,"isFetch":true,"statusText":"success","uploadInfo":{"asset_id":"2448ddf3f766f70f1e477313671fb488","public_id":"nyan-cat-4k_epljbh","version":1636362311,"version_id":"8afdf8293dc8211de2be1315b37d1ab2","signature":"77e182747682e38c8bfc3543357cefb617a8bb2c","width":220,"height":124,"format":"gif","resource_type":"image","created_at":"2021-11-08T09:05:11Z","tags":[],"pages":24,"bytes":35477,"type":"upload","etag":"5e7895f961693adc6b76729f12fdecd3","placeholder":false,"url":"http://res.cloudinary.com/junto/image/upload/v1636362311/nyan-cat-4k_epljbh.gif","secure_url":"https://res.cloudinary.com/junto/image/upload/v1636362311/nyan-cat-4k_epljbh.gif","access_mode":"public","existing":false,"original_filename":"nyan-cat-4k","path":"v1636362311/nyan-cat-4k_epljbh.gif","thumbnail_url":"https://res.cloudinary.com/junto/image/upload/c_limit,h_60,w_90/v1636362311/nyan-cat-4k_epljbh.jpg"}}]}}}
  ...
  String? getYoutubeVideoId(String url) {
    ...
    return regExpMatch != null && regExpMatch.groupCount > 0 ? regExpMatch.group(1) : null;
  }
