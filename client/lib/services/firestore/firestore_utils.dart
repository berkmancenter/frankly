...
class BehaviorSubjectWrapper<T> extends Stream<T> {
  ...
  factory BehaviorSubjectWrapper(Stream<T> stream) {
    ...
    return BehaviorSubjectWrapper._(stream: behaviorSubject, streamSubscription: subscription);
  }

  BehaviorSubjectWrapper._({required this.stream, required this.streamSubscription});
