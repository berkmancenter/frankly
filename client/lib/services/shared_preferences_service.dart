...
class SharedPreferencesService {
  ...
  static const _kIsOnboardingOverviewTooltipShown = 'is-onboarding-overview-tooltip-shown';
  ...
  bool wasMeetingTutorialShown() => _preferences.getBool(_kWasMeetingTutorialShown) ?? false;
  ...
  Future<bool> updateOnboardingOverviewTooltipVisibility(bool isShown) async {
    final result = await _preferences.setBool(_kIsOnboardingOverviewTooltipShown, isShown);
    return result;
  }
  ...
  Future<bool> updateEditTemplateTooltipVisibility(bool isShown) async {
    final result = await _preferences.setBool(_kIsEditTemplateTooltipShown, isShown);
    return result;
  }

  String? getLastQueryParams() => _preferences.getString(_lastQueryParameters);
  Future<void> setLastQueryParameters(String lastQueryParameters) => _preferences.setString(
  ...
  bool getCameraOnByDefault() => _preferences.getBool(_kCameraOnByDefault) ?? false;
  Future<void> _setCameraOnByDefault(bool val) => _preferences.setBool(_kCameraOnByDefault, val);

  bool getMicOnByDefault() => _preferences.getBool(_kMicOnByDefault) ?? false;
  Future<void> _setMicOnByDefault(bool val) => _preferences.setBool(_kMicOnByDefault, val);

  String? getDefaultCameraId() => _preferences.getString(_defaultCameraId);
  Future<bool> setDefaultCameraId(String id) => _preferences.setString(_defaultCameraId, id);

  String? getDefaultMicrophoneId() => _preferences.getString(_defaultMicrophoneId);
