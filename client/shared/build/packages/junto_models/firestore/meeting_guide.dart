...
@Freezed(makeCollectionsUnmodifiable: false)
class MeetingUserSuggestion with _$MeetingUserSuggestion implements SerializeableRequest {
...
class ParticipantAgendaItemDetailsMeta
  ...
  factory ParticipantAgendaItemDetailsMeta.fromJson(Map<String, dynamic> json) =>
