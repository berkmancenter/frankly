...
class Announcement with _$Announcement {
  ...
  factory Announcement({
    ...
    @JsonKey(defaultValue: AnnouncementStatus.active, unknownEnumValue: AnnouncementStatus.active)
  ...
  static Map<String, dynamic>? toJsonForCloudFunction(Announcement? announcement) {
