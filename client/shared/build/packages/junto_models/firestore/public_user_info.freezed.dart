...
class _$_PublicUserInfo implements _PublicUserInfo {
  ...
  @override
  String toString() {
    return 'PublicUserInfo(id: $id, agoraId: $agoraId, displayName: $displayName, imageUrl: $imageUrl, about: $about, socialMediaItems: $socialMediaItems)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, agoraId, displayName,
      imageUrl, about, const DeepCollectionEquality().hash(socialMediaItems));
...
abstract class _PublicUserInfo implements PublicUserInfo {
  factory _PublicUserInfo(
      ...
      final String? imageUrl,
      final String? about,
      final List<SocialMediaItem> socialMediaItems}) = _$_PublicUserInfo;
