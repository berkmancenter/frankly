...
mixin _$Discussion {
  ...
  @JsonKey(
      unknownEnumValue: DiscussionStatus.active,
      defaultValue: DiscussionStatus.active)
  ...
  @JsonKey(unknownEnumValue: null, name: 'discussionType')
  DiscussionType? get nullableDiscussionType =>
...
abstract class $DiscussionCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(unknownEnumValue: null, name: 'discussionType')
      DiscussionType? nullableDiscussionType,
...
class _$DiscussionCopyWithImpl<$Res, $Val extends Discussion>
  ...
  $Res call({
    Object? id = null,
    Object? status = null,
    Object? nullableDiscussionType = freezed,
    ...
    return _then(_value.copyWith(
      ...
      status: null == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as DiscussionStatus,
      nullableDiscussionType: freezed == nullableDiscussionType
          ? _value.nullableDiscussionType
          : nullableDiscussionType // ignore: cast_nullable_to_non_nullable
              as DiscussionType?,
...
class _$_Discussion extends _Discussion {
  ...
  @override
  @JsonKey(unknownEnumValue: null, name: 'discussionType')
  final DiscussionType? nullableDiscussionType;
  @override
  ...
  @override
  String toString() {
    return 'Discussion(id: $id, status: $status, nullableDiscussionType: $nullableDiscussionType, collectionPath: $collectionPath, juntoId: $juntoId, topicId: $topicId, creatorId: $creatorId, prerequisiteTopicId: $prerequisiteTopicId, creatorDisplayName: $creatorDisplayName, createdDate: $createdDate, scheduledTime: $scheduledTime, scheduledTimeZone: $scheduledTimeZone, title: $title, description: $description, image: $image, isPublic: $isPublic, minParticipants: $minParticipants, maxParticipants: $maxParticipants, agendaItems: $agendaItems, waitingRoomInfo: $waitingRoomInfo, breakoutRoomDefinition: $breakoutRoomDefinition, isLocked: $isLocked, liveStreamInfo: $liveStreamInfo, preEventCardData: $preEventCardData, postEventCardData: $postEventCardData, externalPlatform: $externalPlatform, discussionSettings: $discussionSettings, durationInMinutes: $durationInMinutes, externalCommunityId: $externalCommunityId, externalCommunityStatus: $externalCommunityStatus, participantCountEstimate: $participantCountEstimate, presentParticipantCountEstimate: $presentParticipantCountEstimate, breakoutMatchIdsToRecord: $breakoutMatchIdsToRecord)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.nullableDiscussionType, nullableDiscussionType) ||
                other.nullableDiscussionType == nullableDiscussionType) &&
...
abstract class _Discussion extends Discussion {
  factory _Discussion(
      ...
      final int? participantCountEstimate,
      final int? presentParticipantCountEstimate,
      final dynamic breakoutMatchIdsToRecord}) = _$_Discussion;
  _Discussion._() : super._();
...
DiscussionSettings _$DiscussionSettingsFromJson(Map<String, dynamic> json) {
  return _DiscussionSettings.fromJson(json);
}

/// @nodoc
mixin _$DiscussionSettings {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $DiscussionSettingsCopyWith<DiscussionSettings> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DiscussionSettingsCopyWith<$Res> {
  factory $DiscussionSettingsCopyWith(
          DiscussionSettings value, $Res Function(DiscussionSettings) then) =
      _$DiscussionSettingsCopyWithImpl<$Res, DiscussionSettings>;
  @useResult
  $Res call(
      {bool? reminderEmails,
      bool? chat,
...
/// @nodoc
class _$DiscussionSettingsCopyWithImpl<$Res, $Val extends DiscussionSettings>
    implements $DiscussionSettingsCopyWith<$Res> {
  _$DiscussionSettingsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_DiscussionSettingsCopyWith<$Res>
    implements $DiscussionSettingsCopyWith<$Res> {
  factory _$$_DiscussionSettingsCopyWith(_$_DiscussionSettings value,
          $Res Function(_$_DiscussionSettings) then) =
      __$$_DiscussionSettingsCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {bool? reminderEmails,
...
/// @nodoc
class __$$_DiscussionSettingsCopyWithImpl<$Res>
    extends _$DiscussionSettingsCopyWithImpl<$Res, _$_DiscussionSettings>
    implements _$$_DiscussionSettingsCopyWith<$Res> {
  __$$_DiscussionSettingsCopyWithImpl(
      _$_DiscussionSettings _value, $Res Function(_$_DiscussionSettings) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_DiscussionSettings(
      reminderEmails: freezed == reminderEmails
          ? _value.reminderEmails
          : reminderEmails // ignore: cast_nullable_to_non_nullable
              as bool?,
...
/// @nodoc
@JsonSerializable()
class _$_DiscussionSettings implements _DiscussionSettings {
  const _$_DiscussionSettings(
      {this.reminderEmails,
      this.chat,
  ...
  factory _$_DiscussionSettings.fromJson(Map<String, dynamic> json) =>
      _$$_DiscussionSettingsFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_DiscussionSettings &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_DiscussionSettingsCopyWith<_$_DiscussionSettings> get copyWith =>
      __$$_DiscussionSettingsCopyWithImpl<_$_DiscussionSettings>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DiscussionSettingsToJson(
      this,
    );
  }
}

abstract class _DiscussionSettings implements DiscussionSettings {
  const factory _DiscussionSettings(
      {final bool? reminderEmails,
      final bool? chat,
      final bool? showChatMessagesInRealTime,
      final bool? talkingTimer,
      ...
      final bool? alwaysRecord,
      final bool? enablePrerequisites,
      final bool? agendaPreview}) = _$_DiscussionSettings;

  factory _DiscussionSettings.fromJson(Map<String, dynamic> json) =
      _$_DiscussionSettings.fromJson;
...
mixin _$Participant {
  ...
  bool? get optInToAmericaTalks => throw _privateConstructorUsedError;
...
class _$ParticipantCopyWithImpl<$Res, $Val extends Participant>
  ...
  $Res call({
    ...
    Object? optInToAmericaTalks = freezed,
  }) {
    return _then(_value.copyWith(
      id: null == id
          ? _value.id
      ...
      zipCode: freezed == zipCode
          ...
          : zipCode // ignore: cast_nullable_to_non_nullable
              as String?,
      optInToAmericaTalks: freezed == optInToAmericaTalks
          ? _value.optInToAmericaTalks
          : optInToAmericaTalks // ignore: cast_nullable_to_non_nullable
              as bool?,
    ) as $Val);
  }
}
...
class _$_Participant implements _Participant {
  _$_Participant(
      ...
      this.zipCode,
      this.optInToAmericaTalks = false});
...
// TODO(Danny): See if there is a way to do this without duplicating this information on the participant
  ...
  @override
  @JsonKey()
  final bool? optInToAmericaTalks;

  @override
  String toString() {
    return 'Participant(id: $id, juntoId: $juntoId, externalCommunityId: $externalCommunityId, topicId: $topicId, lastUpdatedTime: $lastUpdatedTime, createdDate: $createdDate, scheduledTime: $scheduledTime, status: $status, isPresent: $isPresent, availableForBreakoutSessionId: $availableForBreakoutSessionId, membershipStatus: $membershipStatus, currentBreakoutRoomId: $currentBreakoutRoomId, muteOverride: $muteOverride, joinParameters: $joinParameters, breakoutRoomSurveyQuestions: $breakoutRoomSurveyQuestions, mostRecentPresentTime: $mostRecentPresentTime, zipCode: $zipCode, optInToAmericaTalks: $optInToAmericaTalks)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.optInToAmericaTalks, optInToAmericaTalks) ||
                other.optInToAmericaTalks == optInToAmericaTalks));
  }
...
abstract class _Participant implements Participant {
  factory _Participant(
      ...
      final DateTime? mostRecentPresentTime,
      final String? zipCode,
      final bool? optInToAmericaTalks}) = _$_Participant;
...
DiscussionEmailLog _$DiscussionEmailLogFromJson(Map<String, dynamic> json) {
  return _DiscussionEmailLog.fromJson(json);
}

/// @nodoc
mixin _$DiscussionEmailLog {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $DiscussionEmailLogCopyWith<DiscussionEmailLog> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DiscussionEmailLogCopyWith<$Res> {
  factory $DiscussionEmailLogCopyWith(
          DiscussionEmailLog value, $Res Function(DiscussionEmailLog) then) =
      _$DiscussionEmailLogCopyWithImpl<$Res, DiscussionEmailLog>;
  @useResult
  $Res call(
      {String? userId,
...
/// @nodoc
class _$DiscussionEmailLogCopyWithImpl<$Res, $Val extends DiscussionEmailLog>
    implements $DiscussionEmailLogCopyWith<$Res> {
  _$DiscussionEmailLogCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_DiscussionEmailLogCopyWith<$Res>
    implements $DiscussionEmailLogCopyWith<$Res> {
  factory _$$_DiscussionEmailLogCopyWith(_$_DiscussionEmailLog value,
          $Res Function(_$_DiscussionEmailLog) then) =
      __$$_DiscussionEmailLogCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? userId,
...
/// @nodoc
class __$$_DiscussionEmailLogCopyWithImpl<$Res>
    extends _$DiscussionEmailLogCopyWithImpl<$Res, _$_DiscussionEmailLog>
    implements _$$_DiscussionEmailLogCopyWith<$Res> {
  __$$_DiscussionEmailLogCopyWithImpl(
      _$_DiscussionEmailLog _value, $Res Function(_$_DiscussionEmailLog) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_DiscussionEmailLog(
      userId: freezed == userId
          ? _value.userId
          : userId // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_DiscussionEmailLog implements _DiscussionEmailLog {
  _$_DiscussionEmailLog(
      {this.userId,
      @JsonKey(unknownEnumValue: null) this.discussionEmailType,
      @JsonKey(fromJson: dateTimeFromTimestamp, toJson: timestampFromDateTime)
      this.createdDate,
      this.sendId});

  factory _$_DiscussionEmailLog.fromJson(Map<String, dynamic> json) =>
      _$$_DiscussionEmailLogFromJson(json);
  ...
  @override
  String toString() {
    return 'DiscussionEmailLog(userId: $userId, discussionEmailType: $discussionEmailType, createdDate: $createdDate, sendId: $sendId)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_DiscussionEmailLog &&
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, userId, discussionEmailType, createdDate, sendId);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_DiscussionEmailLogCopyWith<_$_DiscussionEmailLog> get copyWith =>
      __$$_DiscussionEmailLogCopyWithImpl<_$_DiscussionEmailLog>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_DiscussionEmailLogToJson(
      this,
    );
  }
}

abstract class _DiscussionEmailLog implements DiscussionEmailLog {
  factory _DiscussionEmailLog(
      {final String? userId,
      @JsonKey(unknownEnumValue: null)
      final DiscussionEmailType? discussionEmailType,
      @JsonKey(fromJson: dateTimeFromTimestamp, toJson: timestampFromDateTime)
      final DateTime? createdDate,
      final String? sendId}) = _$_DiscussionEmailLog;

  factory _DiscussionEmailLog.fromJson(Map<String, dynamic> json) =
      _$_DiscussionEmailLog.fromJson;
...
class _$_PlatformItem implements _PlatformItem {
  _$_PlatformItem(
      {this.url,
      @JsonKey(defaultValue: PlatformKey.junto, unknownEnumValue: null)
      this.platformKey = PlatformKey.junto});
