...
class _$_ChatSuggestionData implements _ChatSuggestionData {
  ...
  @override
  String toString() {
    return 'ChatSuggestionData(id: $id, creatorId: $creatorId, creatorEmail: $creatorEmail, creatorName: $creatorName, createdDate: $createdDate, message: $message, emotionType: $emotionType, upvotes: $upvotes, downvotes: $downvotes, type: $type, roomId: $roomId, agendaItemId: $agendaItemId)';
  }
...
abstract class _ChatSuggestionData implements ChatSuggestionData {
  factory _ChatSuggestionData(
      ...
      final ChatSuggestionType type,
      final String? roomId,
      final String? agendaItemId}) = _$_ChatSuggestionData;
