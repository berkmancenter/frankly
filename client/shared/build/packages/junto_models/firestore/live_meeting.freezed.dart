...
mixin _$LiveMeetingParticipant {
  ...
  String? get meetingId =>
      throw _privateConstructorUsedError; // Temporary ID to store external community user ID mappings (like Unify America)
...
abstract class $LiveMeetingParticipantCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? juntoId, String? meetingId, String? externalCommunityId});
}
...
class _$_LiveMeetingParticipant implements _LiveMeetingParticipant {
  _$_LiveMeetingParticipant(
      {this.juntoId, this.meetingId, this.externalCommunityId});
...
// This should no longer be necessary when/if we switch to Twilio in Flutter
  ...
  @override
  String toString() {
    return 'LiveMeetingParticipant(juntoId: $juntoId, meetingId: $meetingId, externalCommunityId: $externalCommunityId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, juntoId, meetingId, externalCommunityId);
...
abstract class _LiveMeetingParticipant implements LiveMeetingParticipant {
  ...
  @override
  String? get meetingId;
  @override // Temporary ID to store external community user ID mappings (like Unify America)
// This should no longer be necessary when/if we switch to Twilio in Flutter
