...
@Freezed(makeCollectionsUnmodifiable: false)
class TwilioKickParticipantRequest
    with _$TwilioKickParticipantRequest
    implements SerializeableRequest {
  factory TwilioKickParticipantRequest({
    required String userToKickId,
    required String discussionPath,
    String? breakoutRoomId,
  }) = _TwilioKickParticipantRequest;

  factory TwilioKickParticipantRequest.fromJson(Map<String, dynamic> json) =>
      _$TwilioKickParticipantRequestFromJson(json);
}
