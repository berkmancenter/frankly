...
class LiveMeeting with _$LiveMeeting implements SerializeableRequest {
  ...
  factory LiveMeeting.fromJson(Map<String, dynamic> json) => _$LiveMeetingFromJson(json);
}
...
class LiveMeetingParticipant with _$LiveMeetingParticipant {
  factory LiveMeetingParticipant({
    String? juntoId,
    String? meetingId,
    // Temporary ID to store external community user ID mappings (like Unify America)
...
class LiveMeetingEvent with _$LiveMeetingEvent {
  ...
  factory LiveMeetingEvent.fromJson(Map<String, dynamic> json) => _$LiveMeetingEventFromJson(json);
}

@Freezed(makeCollectionsUnmodifiable: false)
class LiveMeetingRating with _$LiveMeetingRating implements SerializeableRequest {
...
class BreakoutRoom with _$BreakoutRoom implements SerializeableRequest {
  ...
  factory BreakoutRoom({
    ...
    @JsonKey(defaultValue: BreakoutRoomFlagStatus.unflagged, unknownEnumValue: BreakoutRoomFlagStatus.unflagged)
        BreakoutRoomFlagStatus flagStatus,
    @JsonKey(fromJson: dateTimeFromTimestamp, toJson: serverTimestamp) DateTime? createdDate,
    @Default(false) bool record,
  }) = _BreakoutRoom;

  factory BreakoutRoom.fromJson(Map<String, dynamic> json) => _$BreakoutRoomFromJson(json);
}
...
class BreakoutRoomSession with _$BreakoutRoomSession {
  ...
  factory BreakoutRoomSession({
    ...
    @JsonKey(fromJson: dateTimeFromTimestamp, toJson: serverTimestamp) DateTime? statusUpdatedTime,
