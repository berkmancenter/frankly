...
enum MembershipStatus {
  ...
  /// User that joins the conversation and they are not members of that space
  attendee,
...
extension MembershipStatusExtension on MembershipStatus {
  ...
  bool get isMember => [MembershipStatus.member].contains(this) || isFacilitator;

  bool get isFacilitator => [MembershipStatus.facilitator].contains(this) || isMod;
...
class Membership with _$Membership implements SerializeableRequest {
  ...
  factory Membership({
    ...
    @JsonKey(fromJson: dateTimeFromTimestamp, toJson: serverTimestamp) DateTime? firstJoined,
