...
class _$_Membership extends _Membership {
  ...
  @override
  String toString() {
    return 'Membership(userId: $userId, juntoId: $juntoId, status: $status, firstJoined: $firstJoined, invisible: $invisible)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, userId, juntoId, status, firstJoined, invisible);
