...
class _$_PartnerAgreement implements _PartnerAgreement {
  ...
  @override
  String toString() {
    return 'PartnerAgreement(id: $id, allowPayments: $allowPayments, takeRate: $takeRate, initialUserId: $initialUserId, juntoId: $juntoId, stripeConnectedAccountId: $stripeConnectedAccountId, stripeConnectedAccountActive: $stripeConnectedAccountActive, planOverride: $planOverride)';
  }
