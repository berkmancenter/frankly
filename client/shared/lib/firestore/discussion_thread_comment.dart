...
class DiscussionThreadComment with _$DiscussionThreadComment implements SerializeableRequest {
  ...
  factory DiscussionThreadComment({
    required String id,
    @JsonKey(fromJson: dateTimeFromTimestamp, toJson: serverTimestamp) DateTime? createdAt,
