...
TasksModule? get tasks => _tasks ??= require('@google-cloud/tasks') as TasksModule;
TasksModule? _tasks;
...
abstract class CloudTasksClient {
  ...
  external dynamic createTask(CreateTaskRequest request); //[CallOptions callOptions]);
}
...
abstract class Task {
  ...
  external factory Task({String name, HttpRequest httpRequest, Timestamp scheduleTime});
}
