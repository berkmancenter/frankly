...
class UpdateStripeSubscriptionPlan
  ...
  @override
  Future<void> action(UpdateStripeSubscriptionPlanRequest request,
    ...
    final subscriptionSnapshot = await firestore
        ...
        .where(BillingSubscription.kFieldAppliedJuntoId,
            isEqualTo: request.juntoId)
        .get();
    orElseUnauthorized(subscriptionSnapshot.isNotEmpty,
        logMessage:
    ...
    orElseUnauthorized(items.isNotEmpty,
        logMessage:
