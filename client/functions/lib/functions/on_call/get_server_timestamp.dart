...
class GetServerTimestamp extends OnCallMethod<GetServerTimestampRequest> {
  GetServerTimestamp()
      : super(GetServerTimestampRequest.functionName,
            (jsonMap) => GetServerTimestampRequest.fromJson(jsonMap));

  @override
  Future<Map<String, dynamic>> action(
      GetServerTimestampRequest request, CallableContext context) async {
    final result = GetServerTimestampResponse(serverTimestamp: DateTime.now().toUtc()).toJson();
    print(result);
    return result;
  }
