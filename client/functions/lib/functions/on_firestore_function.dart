...
import 'package:junto_functions/utils/onboarding_steps_helper.dart';
  ...
  FutureOr<void> firestoreOnCreate(
    ...
    try {
      ...
      return await onCreate(
          data, parsedData, context.timestamp.toUtc(), context);
    } catch (e, s) {
      print(
  ...
  FutureOr<void> firestoreOnUpdate(
    ...
    try {
      ...
      return await onUpdate(
          changes, before, after, context.timestamp.toUtc(), context);
    } catch (e, s) {
      print(
          'Error during action $functionName. \nException: $e, \nStackTrace: $s.');
      rethrow;
