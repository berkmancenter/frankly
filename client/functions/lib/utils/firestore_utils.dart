...
import 'package:junto_models/firestore/utils_web.dart';
...
final devFirebaseProjectId =
    functions_interop.functions.config.get('app.dev_project_id') ?? '';
bool get isDev => firebaseApp.options.projectId == devFirebaseProjectId;
